...
os.environ['CORRECTOCR_WORKSPACE_ROOTPATH'] = '../workspace'
...
htmlhelp_basename = 'CorrectOCRdoc'
...
man_pages = [
    (master_doc, 'correctocr', 'CorrectOCR Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'CorrectOCR', 'CorrectOCR Documentation',
     author, 'CorrectOCR', 'One line description of project.',
     'Miscellaneous'),
]
...
autodoc_mock_imports = ['pyodbc', 'tesserocr']

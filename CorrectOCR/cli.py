...
def get_root_argparser(defaults = None, serverdefaults = None):
	...
	group.add_argument('--docids', nargs='+', help='Input multiple document IDs')
	...
	group.add_argument('--docid', help='Input document ID (filename without path or extension)')
	group.add_argument('--docids', nargs='+', help='Input multiple document IDs')
	group.add_argument('--all', action='store_true', help='Select all documents')
	group.add_argument('--skip_done', action='store_true', help='Select only unfinished documents')
	...
	statsparser.add_argument('--docids', nargs='+', help='Input multiple document IDs. Overrides --only_done.')
	...
	serverparser.add_argument('--dynamic_images', type=str2bool, help='Should images be generated dynamically?')
	serverparser.add_argument('--redirect_hyphenated', type=str2bool, help='Redirect requests for hyphenated tokens to "head"')
